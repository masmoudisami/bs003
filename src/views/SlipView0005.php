...
<head>
    ...
    <style>
        ...
        .comment-section { background: #fff3cd; padding: 15px; border-radius: 5px; margin: 20px 0; border-left: 4px solid #ffc107; }
        .comment-section h3 { margin: 0 0 10px 0; color: #856404; }
        .comment-section p { margin: 0; color: #856404; white-space: pre-wrap; }
        .slip-details { background: #f8f9fa; padding: 15px; border-radius: 5px; margin: 20px 0; }
        .slip-details p { margin: 8px 0; }
        ...
        /* ============================================ */
        /* STYLES COMPACTS POUR IMPRESSION */
        /* ============================================ */
        ...
        .print-info-box { background: #f8f9fa; padding: 10px; border-radius: 5px; font-size: 0.9em; }
        ...
        .print-financial { background: #e7f3ff; padding: 10px; border-radius: 5px; font-size: 0.9em; }
        ...
        .print-financial p { margin: 3px 0; }
        .print-comment { background: #fff3cd; padding: 10px; border-radius: 5px; margin: 15px 0; border-left: 3px solid #ffc107; font-size: 0.9em; }
        ...
        .print-signatures { margin-top: 30px; display: flex; justify-content: space-between; }
        .print-signature-box { width: 40%; text-align: center; }
        .print-signature-box p { border-top: 1px solid #333; padding-top: 5px; margin: 0; font-size: 0.9em; }
        ...
        @media print { 
            ...
            .bulletin-number { background: #333; color: #fff; padding: 10px 20px; font-size: 1em; }
            h1 { font-size: 1.3em; }
...
<body>
    <div class="container">
        ...
        <?php if (isset($_GET['action']) && $_GET['action'] === 'print' && $slip): ?>
            ...
            <h3 style="margin: 15px 0 10px 0; font-size: 1em;">📝 Détail des Interventions</h3>
            ...
            <div class="print-signatures">
                ...
                <div class="print-signature-box">
                    <p>Cachet du Médecin</p>
                </div>
            </div>

            <div class="no-print" style="margin-top: 30px; text-align: center;">
                <button onclick="window.print()" style="background: #17a2b8; padding: 15px 30px; font-size: 1.1em;">🖨️ Imprimer / PDF</button>
