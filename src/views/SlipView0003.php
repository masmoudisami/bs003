...
<head>
    ...
    <style>
        ...
        @media print { 
            ...
            .comment-section { background: #fff; border: 1px solid #ddd; }
            .slip-details { background: #fff; }
            .financial-info { background: #fff; border: 1px solid #ddd; }
        }
    </style>
</head>
<body>
    <div class="container">
        ...
        <?php if (isset($_GET['action']) && $_GET['action'] === 'print' && $slip): ?>
            ...
            <div class="slip-details">
                ...
                <p><strong>Date des Soins :</strong> <?= date('d/m/Y', strtotime($slip['date_soins'])) ?></p>
                <p><strong>Date de Remboursement :</strong> <?= !empty($slip['date_remboursement']) ? date('d/m/Y', strtotime($slip['date_remboursement'])) : 'Non renseignée' ?></p>
            </div>
            ...
            <div class="no-print" style="margin-top: 50px; display: flex; justify-content: space-between; page-break-inside: avoid;">
                <div style="text-align: center; width: 40%;">
                    <p style="border-top: 1px solid #333; padding-top: 10px;">Signature du Patient</p>
                </div>
                <div style="text-align: center; width: 40%;">
                    <p style="border-top: 1px solid #333; padding-top: 10px;">Cachet du Médecin</p>
                </div>
            </div>
